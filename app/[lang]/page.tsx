...
import LaptopStage from '@/components/home/LaptopStage';
  ...
  return (
    <>
      ...
      <main id="main">
        ...
        {/* The laptop is fixed behind this block and animates across all three
            sections; the sections themselves are ordinary, crawlable markup. */}
        <LaptopStage>
          {/* WHAT WE DO */}
